                  ...
                  <div className="row">
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                      <div className="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
                        ...
                        <h3 className="text-black h4">Camera</h3>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                      <div className="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
                        ...
                        <h3 className="text-black h4">Wedding Photography</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id dolorum debitis.</p>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                      <div className="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
                        ...
                        <h3 className="text-black h4">Animal</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id dolorum debitis.</p>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                      <div className="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id dolorum debitis.</p>
                        <p><strong className="font-weight-bold text-primary">$40</strong></p>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                      <div className="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
                        <span className="icon flaticon-eiffel-tower display-3 text-primary mb-4 d-block"></span>
                        <h3 className="text-black h4">Travel</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id dolorum debitis.</p>
                        <p><strong className="font-weight-bold text-primary">$35</strong></p>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-6 col-xl-4 text-center mb-5 mb-lg-5">
                      <div className="h-100 p-4 p-lg-5 bg-light site-block-feature-7">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum exercitationem quae id dolorum debitis.</p>
                        <p><strong className="font-weight-bold text-primary">$15</strong></p>
                      </div>
                    </div>
